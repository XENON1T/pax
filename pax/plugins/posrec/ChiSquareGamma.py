...
class PosRecChiSquareGamma(plugin.PosRecPlugin):
    ...
    def reconstruct_position(self, peak):
        """Reconstruct position by minimizing hitpattern goodness of fit to per-PMT LCE map.
        Secondaly, append a chi_square_gamma value and ndf to existing ReconstructedPosition objects.
        """
        ...
        # Give up if we're asked to do nothing or if the peak's area is above a threshold (performance option)
        # In either case a nan-po
        ...
        # Return our reconstructed position
        return {'x': x,
                'y': y,
