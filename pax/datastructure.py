...
from pax.fields import IntegerField, FloatField, ModelCollectionField, BooleanField, StringField, FieldCollectionField

class Peak(Model):
    """Peak object

    Used for either S1 or S2
    """
...
class Event(Model):
    ...
    #: Unused array (userful for developing)
    user_array_0 = FieldCollectionField(default=[],
                                    field_instance=FloatField())

    #: List of S1 (scintillation) signals
    #
    #: Returns an :class:`pax.datastructure.Peak2` class.
