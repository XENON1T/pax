...
from pax.plugins.io.Queues import PullFromSharedMemoryQueue, PushToSharedMemoryQueue, NoMoreEvents
...
class TestMultiprocessing(unittest.TestCase):
    ...
    def test_push(self):
        ...
        self.assertIsInstance(blocks_out[-1][1], NoMoreEvents)
